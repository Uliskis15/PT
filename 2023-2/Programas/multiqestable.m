...
figure(1)
plot(0:C-1,bw(1,:),'b','LineWidth',1.5)
xlim([0 C])
hold on
plot(0:C-1,bw(2,:),'m--','LineWidth',1)
plot(0:C-1,bw(3,:),'c*','LineWidth',0.5)
hold off
...
figure(2)
plot(0:C-1,bwp2p(1,:),'b','LineWidth',1.5)
xlim([0 C])
hold on
plot(0:C-1,bwp2p(2,:),'m--','LineWidth',1)
plot(0:C-1,bwp2p(3,:),'c*','LineWidth',0.5)
hold off
legend('Q=12','Q=24','Q=36')
%xticks([0:2:36])
xlabel('\iti')
...
figure(3)
plot(0:C-1,bwser(1,:),'b','LineWidth',1.5)
xlim([0 C])
hold on
plot(0:C-1,bwser(2,:),'m--','LineWidth',1)
plot(0:C-1,bwser(3,:),'c*','LineWidth',0.5)
hold off
legend('Q=12','Q=24','Q=36')
%xticks([0:2:C])
xlabel('i')
