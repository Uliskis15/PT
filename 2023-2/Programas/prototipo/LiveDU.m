...
for idxc=1:length(C)
   ...
   for idxt=1:length(teta) 
      ...
      TArr=0;%Promedio para exprnd de conexión
      TAb=zeros(1,C(idxc)+1);%Promedio para exprnd de desconexión
      ttran=0;%Promedio para exprnd de producción     
